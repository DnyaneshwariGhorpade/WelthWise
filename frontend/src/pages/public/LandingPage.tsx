  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-6xl font-extrabold leading-tight tracking-tight">
              Your AI-Powered<br />Personal Wealth Planner
            </h1>
            <p className="mt-6 text-lg md:text-xl text-emerald-100 max-w-2xl">
              WealthWise analyzes your complete financial picture and delivers actionable insights
              to help you build, protect, and grow your wealth with confidence.
            </p>
        ...
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30" />
      </section>
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((f) => (
              <div key={f.title} className="bg-slate-50 rounded-2xl p-8 border border-slate-100 hover:border-emerald-200 hover:shadow-md transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-5 mb-8 flex gap-3 items-start">
            ...
            <p className="text-xs leading-relaxed text-slate-400">
              <span className="font-semibold text-slate-300">AI Disclaimer:</span> WealthWise uses artificial intelligence to generate financial insights, scores, and recommendations.
              This content is <strong className="text-slate-300">for informational and educational purposes only</strong> and does not constitute certified financial advice.
